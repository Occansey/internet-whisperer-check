...
const translations = {
  fr: {
    ...
    'governance.direction.description': 'Découvrez l\'équipe dirigeante de Solio Group',
    'governance.committee.title': 'Comité Exécutif',
    'governance.committee.description': 'Le comité exécutif pilote la stratégie et les orientations du groupe',
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    'governance.direction.description': 'Meet the management team of Solio Group',
    'governance.committee.title': 'Executive Committee',
    'governance.committee.description': 'The executive committee drives the strategy and direction of the group',
  }
};
