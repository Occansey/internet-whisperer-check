...
const translations = {
  fr: {
    ...
    'showrooms.contact.secondary_email': 'Email Secondaire',
  ...
  en: {
    ...
    'showrooms.contact.secondary_email': 'Secondary Email',
    'showrooms.services.title': 'Our Services',
    'showrooms.services.solar_demo': '• Solar solution demonstrations',
    'showrooms.services.storage_test': '• Energy storage system testing',
    ...
    'showrooms.zanzibar_showroom.content.p3': 'The Kijani Commercial Park is the first fully eco and green mall in Zanzibar and Tanzania, which is equipped with energy management and efficiency solution, battery energy storage back up, electric vehicle charging station and fully operational Solar Power Plant.',
    'showrooms.zanzibar_showroom.content.p4': 'In Fumba Town, Zanzibar\'s eco-city, we are implementing several projects for CPS Africa, including Solar Plant and Battery Energy Storage Plant.',
    ...
    'showrooms.zanzibar_showroom.features.storage': 'Energy Storage',
    'showrooms.zanzibar_showroom.features.storage_desc': 'Advanced battery energy storage solutions',
    ...
    'showrooms.contact_form.services_battery': 'Energy storage',
