...
const translations = {
  ...
  en: {
    ...
    showrooms: {
      'title': 'Our Showrooms',
      'subtitle': 'Discover our exhibition spaces dedicated to clean energy and electric mobility solutions',
      'meta.title': 'Showrooms - Growth Energy',
      'meta.description': 'Visit our Growth Energy showrooms to discover our clean energy and electric mobility solutions. Showrooms in Zanzibar with comprehensive solutions.',
      'meta.keywords': 'showroom, energy solutions, electric mobility, Zanzibar, clean energy, solar power, battery storage',
      'our_spaces': 'Our Exhibition Spaces',
      'our_spaces_description': 'Visit our showrooms to discover up close our innovative clean energy and electric mobility solutions',
      'zanzibar_title': 'Zanzibar, Tanzania',
      'zanzibar_description': 'Two exhibition spaces: Fumba Town and Jambiani/Paje',
      'zanzibar_content': 'Complete clean energy and electric mobility solutions in Fumba Town eco-city and at Kijani Commercial Park.',
      'discover': 'Discover',
      'coming_soon': 'Coming Soon',
      'coming_soon_description': 'Other showrooms in development',
      'new_showroom_soon': 'New showroom coming soon',
      'new_showrooms_development': 'We are developing new exhibition spaces in other strategic regions.',
      'plan_visit': 'Plan Your Visit',
      'plan_visit_description': 'Contact us to organize a personalized visit to our showrooms',
      'contact_info': 'Contact Information',
      'primary_email': 'Primary Email',
      'secondary_email': 'Secondary Email',
      'our_services': 'Our Services',
      'service_solar_demo': '• Solar solution demonstrations',
      'service_energy_test': '• Energy storage system testing',
      'service_ev_test': '• Electric vehicle testing',
      'service_consultation': '• Personalized consultations',
      'zanzibar_showroom': {
        'title': 'Zanzibar Showrooms',
        'subtitle': 'Discover our integrated clean energy and electric mobility solutions',
        'meta.title': 'Zanzibar Showroom | Growth Energy - Clean Energy Solutions',
        'meta.description': 'Visit our Zanzibar showrooms in Fumba Town and Jambiani/Paje. Discover our integrated clean energy and electric mobility solutions in Tanzania.',
        'meta.keywords': 'Zanzibar showroom, Growth Energy, clean energy, solar power, electric mobility, Fumba Town, Jambiani, Tanzania',
        'location': 'Zanzibar, Tanzania',
        'showroom_title': 'Zanzibar',
        'content_p1': 'In Zanzibar, we are proud of our unique position as the foremost fully integrated clean energy and electric mobility company, with two offices and show rooms - one in Fumba, and the other in Jambiani/Paje.',
        'content_p2': 'We have just launched our office and show room in Fumba Town and concluding preparations to fully launch our show room in Jambiani at the Kijani Commercial Park.',
        'content_p3': 'The Kijani Commercial Park is the first fully eco and green mall in Zanzibar and Tanzania, which is equipped with energy management and efficiency solution, battery energy storage back up, electric vehicle charging station and fully operational Solar Power Plant.',
        'content_p4': 'In Fumba Town, Zanzibar\'s eco-city, we are implementing several projects for CPS Africa, including Solar Plant and Battery Energy Storage Plant.',
        'content_p5': 'To celebrate this, we are running a campaign and giving out free and complimentary gifts to eligible respondents - in partnership with Escrow tech Uk. Eligible clients stand the chance to win multiple energy management solutions.',
        'solar_solutions': 'Solar Solutions',
        'solar_solutions_desc': 'Complete solar power systems and energy management',
        'energy_storage': 'Energy Storage',
        'energy_storage_desc': 'Advanced battery energy storage solutions',
        'ev_charging': 'EV Charging',
        'ev_charging_desc': 'Electric vehicle charging stations',
        'two_locations': 'Two Locations',
        'two_locations_desc': 'Fumba Town & Jambiani/Paje',
        'visit_showrooms': 'Visit Our Showrooms',
        'fumba_office': 'Fumba Town Office',
        'fumba_address': 'Fumba Town, Main Entrance, Urban West P.O. Box 3564, Zanzibar',
        'fumba_description': 'Located in Zanzibar\'s premier eco-city, implementing solar and battery storage projects.',
        'kijani_park': 'Kijani Commercial Park',
        'kijani_address': 'Kijani Commercial Park, Jambiani/Paje, Zanzibar',
        'kijani_description': 'Tanzania\'s first fully eco and green mall with complete energy management solutions.'
      },
      'contact_form': {
        'title': 'Visit Request',
        'full_name': 'Full Name',
        ...
        'phone': 'Phone',
        'company': 'Company',
        'desired_showroom': 'Desired Showroom',
        ...
        'showroom_placeholder': 'Select a showroom',
        'services_placeholder': 'Which services interest you?',
        'message_placeholder': 'Describe your specific needs or questions...',
        'showroom_fumba': 'Zanzibar - Fumba Town',
        'showroom_jambiani': 'Zanzibar - Jambiani/Paje',
        'showroom_both': 'Both showrooms',
        'service_solar': 'Solar solutions',
        'service_battery': 'Energy storage',
        'service_electric_mobility': 'Electric mobility',
        'service_energy_management': 'Energy management',
        'service_all': 'All solutions',
        'submit_sending': 'Sending...',
        'submit_send': 'Send Request',
        'success_title': 'Message Sent',
        'success_description': 'Your request has been sent successfully. We will contact you soon.',
        'error_title': 'Error',
        'error_description': 'An error occurred while sending. Please try again.'
      }
    },
    stats: {
