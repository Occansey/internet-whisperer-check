...
const translations = {
  fr: {
    ...
    'executives.evrard.bio': 'Fort de plus de 15 ans d\'expérience dans le secteur énergétique et l\'entrepreneuriat, Evrard Havyarimana a fondé Solio Group avec la vision de révolutionner l\'accès à l\'énergie en Afrique. Diplômé en ingénierie et titulaire d\'un MBA, il a dirigé plusieurs projets d\'envergure dans le domaine des énergies renouvelables.',
    'executives.john.title': 'Directeur Général Adjoint',
    'executives.john.bio': 'Spécialiste reconnu en développement de projets énergétiques, John Okoro apporte une expertise technique et commerciale précieuse. Son expérience internationale et sa connaissance approfondie des marchés africains font de lui un pilier de notre expansion.',
    'executives.laure.title': 'Directrice des Opérations',
    'executives.laure.bio': 'Laure Duhorane supervise l\'ensemble des opérations du groupe avec une approche axée sur l\'excellence opérationnelle. Son expertise en gestion de projets complexes et en optimisation des processus garantit la qualité de nos réalisations.',
    'executives.isabelle.title': 'Directrice Financière',
    'executives.isabelle.bio': 'Isabelle Mauboussin pilote la stratégie financière du groupe et supervise l\'ensemble des aspects comptables et financiers. Son expertise en financement de projets et en gestion des risques contribue à la solidité financière de Solio Group.',
    'executives.alain.title': 'Directeur Technique',
    'executives.alain.bio': 'Alain Normand dirige l\'innovation technique et supervise le développement des solutions technologiques du groupe. Son expertise en ingénierie et en R&D permet à Solio Group de rester à la pointe de l\'innovation.',
  ...
  en: {
    ...
    'executives.evrard.bio': 'With over 15 years of experience in the energy sector and entrepreneurship, Evrard Havyarimana founded Solio Group with the vision of revolutionizing energy access in Africa. An engineering graduate with an MBA, he has led several major renewable energy projects.',
    'executives.john.title': 'Deputy CEO',
    'executives.john.bio': 'A recognized specialist in energy project development, John Okoro brings valuable technical and commercial expertise. His international experience and deep knowledge of African markets make him a pillar of our expansion.',
    'executives.laure.title': 'Chief Operating Officer',
    'executives.laure.bio': 'Laure Duhorane oversees all group operations with an approach focused on operational excellence. Her expertise in complex project management and process optimization ensures the quality of our achievements.',
    'executives.isabelle.title': 'Chief Financial Officer',
    'executives.isabelle.bio': 'Isabelle Mauboussin drives the group\'s financial strategy and supervises all accounting and financial aspects. Her expertise in project financing and risk management contributes to Solio Group\'s financial strength.',
    'executives.alain.title': 'Chief Technology Officer',
    'executives.alain.bio': 'Alain Normand leads technical innovation and supervises the development of the group\'s technological solutions. His expertise in engineering and R&D allows Solio Group to stay at the forefront of innovation.',
