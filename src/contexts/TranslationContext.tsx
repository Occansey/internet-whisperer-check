...
const translations = {
  fr: {
    ...
    // Showrooms
    'showrooms.title': 'Nos Showrooms',
    'showrooms.description': 'Visitez nos showrooms Growth Energy pour découvrir nos solutions d\'énergie propre et de mobilité électrique. Showrooms à Zanzibar avec des solutions complètes.',
    'showrooms.keywords': 'showroom, energy solutions, electric mobility, Zanzibar, clean energy, solar power, battery storage',
    'showrooms.hero.title': 'Nos Showrooms',
    'showrooms.hero.subtitle': 'Découvrez nos espaces d\'exposition dédiés aux solutions d\'énergie propre et de mobilité électrique',
    'showrooms.spaces.title': 'Nos Espaces d\'Exposition',
    'showrooms.spaces.description': 'Visitez nos showrooms pour découvrir de près nos solutions innovantes d\'énergie propre et de mobilité électrique',
    'showrooms.zanzibar.location': 'Zanzibar, Tanzanie',
    'showrooms.zanzibar.locations_desc': 'Deux espaces d\'exposition : Fumba Town et Jambiani/Paje',
    'showrooms.zanzibar.description': 'Solutions complètes d\'énergie propre et de mobilité électrique dans l\'éco-ville de Fumba Town et au Kijani Commercial Park.',
    'showrooms.zanzibar.discover': 'Découvrir',
    'showrooms.future.title': 'Prochainement',
    'showrooms.future.description': 'D\'autres showrooms en développement',
    'showrooms.future.coming_soon': 'Nouveau showroom bientôt',
    'showrooms.future.development': 'Nous développons de nouveaux espaces d\'exposition dans d\'autres régions stratégiques.',
    'showrooms.visit.title': 'Planifiez Votre Visite',
    'showrooms.visit.description': 'Contactez-nous pour organiser une visite personnalisée de nos showrooms',
    'showrooms.contact.title': 'Informations de Contact',
    'showrooms.contact.primary_email': 'Email Principal',
    'showrooms.contact.secondary_email': 'Email Principal',
    'showrooms.services.title': 'Nos Services',
    'showrooms.services.solar_demo': '• Démonstrations de solutions solaires',
    'showrooms.services.storage_test': '• Test de systèmes de stockage d\'énergie',
    'showrooms.services.ev_test': '• Essais de véhicules électriques',
    'showrooms.services.consultation': '• Consultations personnalisées',

    // Zanzibar Showroom
    'showrooms.zanzibar_showroom.title': 'Showrooms Zanzibar',
    'showrooms.zanzibar_showroom.description': 'Visitez nos showrooms de Zanzibar à Fumba Town et Jambiani/Paje. Découvrez nos solutions intégrées d\'énergie propre et de mobilité électrique en Tanzanie.',
    'showrooms.zanzibar_showroom.keywords': 'Zanzibar showroom, Growth Energy, énergie propre, énergie solaire, mobilité électrique, Fumba Town, Jambiani, Tanzanie',
    'showrooms.zanzibar_showroom.hero.title': 'Showrooms Zanzibar',
    'showrooms.zanzibar_showroom.hero.subtitle': 'Découvrez nos solutions intégrées d\'énergie propre et de mobilité électrique',
    'showrooms.zanzibar_showroom.location_badge': 'Zanzibar, Tanzanie',
    'showrooms.zanzibar_showroom.main_title': 'Zanzibar',
    'showrooms.zanzibar_showroom.content.p1': 'À Zanzibar, nous sommes fiers de notre position unique en tant que principale entreprise entièrement intégrée d\'énergie propre et de mobilité électrique, avec deux bureaux et showrooms - un à Fumba, et l\'autre à Jambiani/Paje.',
    'showrooms.zanzibar_showroom.content.p2': 'Nous venons de lancer notre bureau et showroom à Fumba Town et finalisons les préparatifs pour lancer entièrement notre showroom à Jambiani au Kijani Commercial Park.',
    'showrooms.zanzibar_showroom.content.p3': 'Le Kijani Commercial Park est le premier centre commercial entièrement écologique et vert de Zanzibar et de Tanzanie, équipé d\'une solution de gestion et d\'efficacité énergétique, de sauvegarde de stockage d\'énergie par batterie, de station de charge de véhicule électrique et d\'une centrale solaire entièrement opérationnelle.',
    'showrooms.zanzibar_showroom.content.p4': 'À Fumba Town, l\'éco-ville de Zanzibar, nous mettons en œuvre plusieurs projets pour CPS Africa, notamment une centrale solaire et une centrale de stockage d\'énergie par batterie.',
    'showrooms.zanzibar_showroom.content.p5': 'Pour célébrer cela, nous organisons une campagne et offrons des cadeaux gratuits et complémentaires aux répondants éligibles - en partenariat avec Escrow tech UK. Les clients éligibles ont la chance de gagner plusieurs solutions de gestion de l\'énergie.',
    'showrooms.zanzibar_showroom.features.solar': 'Solutions Solaires',
    'showrooms.zanzibar_showroom.features.solar_desc': 'Systèmes d\'énergie solaire complets et gestion énergétique',
    'showrooms.zanzibar_showroom.features.storage': 'Stockage d\'Énergie',
    'showrooms.zanzibar_showroom.features.storage_desc': 'Solutions avancées de stockage d\'énergie par batterie',
    'showrooms.zanzibar_showroom.features.charging': 'Recharge VE',
    'showrooms.zanzibar_showroom.features.charging_desc': 'Stations de recharge de véhicules électriques',
    'showrooms.zanzibar_showroom.features.locations': 'Deux Emplacements',
    'showrooms.zanzibar_showroom.features.locations_desc': 'Fumba Town & Jambiani/Paje',
    'showrooms.zanzibar_showroom.visit.title': 'Visitez Nos Showrooms',
    'showrooms.zanzibar_showroom.fumba.title': 'Bureau Fumba Town',
    'showrooms.zanzibar_showroom.fumba.address': 'Fumba Town, Entrée Principale, Urban West P.O. Box 3564, Zanzibar',
    'showrooms.zanzibar_showroom.fumba.description': 'Situé dans la première éco-ville de Zanzibar, mettant en œuvre des projets solaires et de stockage par batterie.',
    'showrooms.zanzibar_showroom.kijani.title': 'Parc Commercial Kijani',
    'showrooms.zanzibar_showroom.kijani.address': 'Parc Commercial Kijani, Jambiani/Paje, Zanzibar',
    'showrooms.zanzibar_showroom.kijani.description': 'Le premier centre commercial entièrement écologique et vert de Tanzanie avec des solutions complètes de gestion énergétique.',

    // Contact Form
    'showrooms.contact_form.title': 'Demande de Visite',
    'showrooms.contact_form.name': 'Nom complet *',
    'showrooms.contact_form.name_placeholder': 'Votre nom complet',
    'showrooms.contact_form.email': 'Email *',
    'showrooms.contact_form.email_placeholder': 'votre@email.com',
    'showrooms.contact_form.phone': 'Téléphone',
    'showrooms.contact_form.phone_placeholder': 'Votre numéro de téléphone',
    'showrooms.contact_form.company': 'Entreprise',
    'showrooms.contact_form.company_placeholder': 'Nom de votre entreprise',
    'showrooms.contact_form.showroom': 'Showroom souhaité',
    'showrooms.contact_form.showroom_placeholder': 'Sélectionnez un showroom',
    'showrooms.contact_form.showroom_fumba': 'Zanzibar - Fumba Town',
    'showrooms.contact_form.showroom_jambiani': 'Zanzibar - Jambiani/Paje',
    'showrooms.contact_form.showroom_both': 'Les deux showrooms',
    'showrooms.contact_form.visit_date': 'Date souhaitée',
    'showrooms.contact_form.services': 'Services d\'intérêt',
    'showrooms.contact_form.services_placeholder': 'Quels services vous intéressent ?',
    'showrooms.contact_form.services_solar': 'Solutions solaires',
    'showrooms.contact_form.services_battery': 'Stockage d\'énergie',
    'showrooms.contact_form.services_mobility': 'Mobilité électrique',
    'showrooms.contact_form.services_management': 'Gestion d\'énergie',
    'showrooms.contact_form.services_all': 'Toutes les solutions',
    'showrooms.contact_form.message': 'Message',
    'showrooms.contact_form.message_placeholder': 'Décrivez vos besoins ou questions spécifiques...',
    'showrooms.contact_form.submit': 'Envoyer la demande',
    'showrooms.contact_form.submitting': 'Envoi en cours...',
    'showrooms.contact_form.success_title': 'Message envoyé',
    'showrooms.contact_form.success_message': 'Votre demande a été envoyée avec succès. Nous vous recontacterons bientôt.',
    'showrooms.contact_form.error_title': 'Erreur',
    'showrooms.contact_form.error_message': 'Une erreur s\'est produite lors de l\'envoi. Veuillez réessayer.',
    ...
    'executives.isabelle.title': 'Directrice Administrative et Financière',
    ...
    'careers.jobs.details': 'Voir détails',
    'careers.jobs.apply': 'Postuler',
    'careers.jobs.search': 'Rechercher un poste...',
    'careers.jobs.filters.department': 'Département',
    'careers.jobs.filters.jobType': 'Type de contrat',
    'careers.jobs.filters.location': 'Localisation',
    'careers.jobs.filters.allDepartments': 'Tous départements',
    'careers.jobs.filters.allTypes': 'Tous types',
    'careers.jobs.filters.allLocations': 'Toutes localisations',
    'careers.jobs.filters.active': 'Filtres actifs',
    'careers.jobs.filters.clearAll': 'Effacer tout',
    'careers.jobs.noResults': 'Aucune offre ne correspond à vos critères.',
    'careers.jobs.oneResult': '1 offre trouvée',
    'careers.jobs.resultsFound': 'offres trouvées',
    'careers.jobs.backToJobs': 'Retour aux offres',
    'careers.jobs.requirements': 'Exigences',
    'careers.jobs.qualifications': 'Qualifications souhaitées',
    'careers.jobs.benefits': 'Avantages',
    'careers.jobs.interestedTitle': 'Intéressé(e) par ce poste ?',
    'careers.jobs.interestedDesc': 'Postulez dès maintenant et rejoignez notre équipe.',
    'careers.jobs.share': 'Partager l\'offre',
  ...
  en: {
    ...
    // Showrooms
    'showrooms.title': 'Our Showrooms',
    'showrooms.description': 'Visit our Growth Energy showrooms to discover our clean energy and electric mobility solutions. Showrooms in Zanzibar with comprehensive solutions.',
    'showrooms.keywords': 'showroom, energy solutions, electric mobility, Zanzibar, clean energy, solar power, battery storage',
    'showrooms.hero.title': 'Our Showrooms',
    'showrooms.hero.subtitle': 'Discover our exhibition spaces dedicated to clean energy and electric mobility solutions',
    'showrooms.spaces.title': 'Our Exhibition Spaces',
    'showrooms.spaces.description': 'Visit our showrooms to discover our innovative clean energy and electric mobility solutions up close',
    'showrooms.zanzibar.location': 'Zanzibar, Tanzania',
    'showrooms.zanzibar.locations_desc': 'Two exhibition spaces: Fumba Town and Jambiani/Paje',
    'showrooms.zanzibar.description': 'Complete clean energy and electric mobility solutions in Fumba Town eco-city and at Kijani Commercial Park.',
    'showrooms.zanzibar.discover': 'Discover',
    'showrooms.future.title': 'Coming Soon',
    'showrooms.future.description': 'More showrooms in development',
    'showrooms.future.coming_soon': 'New showroom coming soon',
    'showrooms.future.development': 'We are developing new exhibition spaces in other strategic regions.',
    'showrooms.visit.title': 'Plan Your Visit',
    'showrooms.visit.description': 'Contact us to arrange a personalized visit to our showrooms',
    'showrooms.contact.title': 'Contact Information',
    'showrooms.contact.primary_email': 'Primary Email',
    'showrooms.contact.secondary_email': 'Primary Email',
    'showrooms.services.title': 'Our Services',
    'showrooms.services.solar_demo': '• Solar solution demonstrations',
    'showrooms.services.storage_test': '• Power backup solutions testing',
    'showrooms.services.ev_test': '• Electric vehicle trials',
    'showrooms.services.consultation': '• Personalized consultations',

    // Zanzibar Showroom
    'showrooms.zanzibar_showroom.title': 'Zanzibar Showrooms',
    'showrooms.zanzibar_showroom.description': 'Visit our Zanzibar showrooms in Fumba Town and Jambiani/Paje. Discover our integrated clean energy and electric mobility solutions in Tanzania.',
    'showrooms.zanzibar_showroom.keywords': 'Zanzibar showroom, Growth Energy, clean energy, solar power, electric mobility, Fumba Town, Jambiani, Tanzania',
    'showrooms.zanzibar_showroom.hero.title': 'Zanzibar Showrooms',
    'showrooms.zanzibar_showroom.hero.subtitle': 'Discover our integrated clean energy and electric mobility solutions',
    'showrooms.zanzibar_showroom.location_badge': 'Zanzibar, Tanzania',
    'showrooms.zanzibar_showroom.main_title': 'Zanzibar',
    'showrooms.zanzibar_showroom.content.p1': 'In Zanzibar, we are proud of our unique position as the foremost fully integrated clean energy and electric mobility company, with two offices and show rooms - one in Fumba, and the other in Jambiani/Paje.',
    'showrooms.zanzibar_showroom.content.p2': 'We have just launched our office and show room in Fumba Town and concluding preparations to fully launch our show room in Jambiani at the Kijani Commercial Park.',
    'showrooms.zanzibar_showroom.content.p3': 'The Kijani Commercial Park is the first fully eco and green mall in Zanzibar and Tanzania, which is equipped with energy management and efficiency solution, power backup solutions, electric vehicle charging station and fully operational Solar Power Plant.',
    'showrooms.zanzibar_showroom.content.p4': 'In Fumba Town, Zanzibar\'s eco-city, we are implementing several projects for CPS Africa, including Solar Plant and Power Backup Solutions Plant.',
    'showrooms.zanzibar_showroom.content.p5': 'To celebrate this, we are running a campaign and giving out free and complimentary gifts to eligible respondents - in partnership with Escrow tech Uk. Eligible clients stand the chance to win multiple energy management solutions.',
    'showrooms.zanzibar_showroom.features.solar': 'Solar Solutions',
    'showrooms.zanzibar_showroom.features.solar_desc': 'Complete solar power systems and energy management',
    'showrooms.zanzibar_showroom.features.storage': 'Power Backup Solutions',
    'showrooms.zanzibar_showroom.features.storage_desc': 'Advanced power backup solutions',
    'showrooms.zanzibar_showroom.features.charging': 'EV Charging',
    'showrooms.zanzibar_showroom.features.charging_desc': 'Electric vehicle charging stations',
    'showrooms.zanzibar_showroom.features.locations': 'Two Locations',
    'showrooms.zanzibar_showroom.features.locations_desc': 'Fumba Town & Jambiani/Paje',
    'showrooms.zanzibar_showroom.visit.title': 'Visit Our Showrooms',
    'showrooms.zanzibar_showroom.fumba.title': 'Fumba Town Office',
    'showrooms.zanzibar_showroom.fumba.address': 'Fumba Town, Main Entrance, Urban West P.O. Box 3564, Zanzibar',
    'showrooms.zanzibar_showroom.fumba.description': 'Located in Zanzibar\'s premier eco-city, implementing solar and battery storage projects.',
    'showrooms.zanzibar_showroom.kijani.title': 'Kijani Commercial Park',
    'showrooms.zanzibar_showroom.kijani.address': 'Kijani Commercial Park, Jambiani/Paje, Zanzibar',
    'showrooms.zanzibar_showroom.kijani.description': 'Tanzania\'s first fully eco and green mall with complete energy management solutions.',

    // Contact Form
    'showrooms.contact_form.title': 'Visit Request',
    'showrooms.contact_form.name': 'Full Name *',
    'showrooms.contact_form.name_placeholder': 'Your full name',
    'showrooms.contact_form.email': 'Email *',
    'showrooms.contact_form.email_placeholder': 'your@email.com',
    'showrooms.contact_form.phone': 'Phone',
    'showrooms.contact_form.phone_placeholder': 'Your phone number',
    'showrooms.contact_form.company': 'Company',
    'showrooms.contact_form.company_placeholder': 'Your company name',
    'showrooms.contact_form.showroom': 'Preferred Showroom',
    'showrooms.contact_form.showroom_placeholder': 'Select a showroom',
    'showrooms.contact_form.showroom_fumba': 'Zanzibar - Fumba Town',
    'showrooms.contact_form.showroom_jambiani': 'Zanzibar - Jambiani/Paje',
    'showrooms.contact_form.showroom_both': 'Both showrooms',
    'showrooms.contact_form.visit_date': 'Preferred Date',
    'showrooms.contact_form.services': 'Services of Interest',
    'showrooms.contact_form.services_placeholder': 'What services interest you?',
    'showrooms.contact_form.services_solar': 'Solar solutions',
    'showrooms.contact_form.services_battery': 'Power backup solutions',
    'showrooms.contact_form.services_mobility': 'Electric mobility',
    'showrooms.contact_form.services_management': 'Energy management',
    'showrooms.contact_form.services_all': 'All solutions',
    'showrooms.contact_form.message': 'Message',
    'showrooms.contact_form.message_placeholder': 'Describe your specific needs or questions...',
    'showrooms.contact_form.submit': 'Send Request',
    'showrooms.contact_form.submitting': 'Sending...',
    'showrooms.contact_form.success_title': 'Message Sent',
    'showrooms.contact_form.success_message': 'Your request has been sent successfully. We will contact you soon.',
    'showrooms.contact_form.error_title': 'Error',
    'showrooms.contact_form.error_message': 'An error occurred while sending. Please try again.',
    ...
    'careers.jobs.details': 'View details',
    'careers.jobs.apply': 'Apply now',
    'careers.jobs.search': 'Search for a position...',
    'careers.jobs.filters.department': 'Department',
    'careers.jobs.filters.jobType': 'Job type',
    'careers.jobs.filters.location': 'Location',
    'careers.jobs.filters.allDepartments': 'All departments',
    'careers.jobs.filters.allTypes': 'All types',
    'careers.jobs.filters.allLocations': 'All locations',
    'careers.jobs.filters.active': 'Active filters',
    'careers.jobs.filters.clearAll': 'Clear all',
    'careers.jobs.noResults': 'No job matches your criteria.',
    'careers.jobs.oneResult': '1 job found',
    'careers.jobs.resultsFound': 'jobs found',
    'careers.jobs.backToJobs': 'Back to jobs',
    'careers.jobs.requirements': 'Requirements',
    'careers.jobs.qualifications': 'Preferred qualifications',
    'careers.jobs.benefits': 'Benefits',
    'careers.jobs.interestedTitle': 'Interested in this position?',
    'careers.jobs.interestedDesc': 'Apply now and join our team.',
    'careers.jobs.share': 'Share job',
