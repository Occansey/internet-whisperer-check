...
const HeroBanner = ({ title, subtitle, description, children, glowColor = "solio-yellow" }: HeroBannerProps) => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-solio-blue to-blue-900 text-white overflow-hidden py-24">
      ...
      <div className="container relative z-20">
        <div className="max-w-4xl">
          ...
          {description && (
            <p className="text-xl md:text-2xl mb-8 text-gray-100 max-w-3xl leading-relaxed">
              {description}
            </p>
          )}
