...
const executives: ExecutiveMemberProps[] = [
  ...
  {
    photo: "/lovable-uploads/6b1a6995-4059-49ea-a2f4-d1792255a41a.png",
    name: "Laure Duhorane",
  ...
  {
    photo: "/lovable-uploads/4e417d6c-4a87-4769-9701-3370c99e44cc.png",
  ...
  },
  {
    ...
    bio: "Passionné de gestion d'entreprise efficace, Alain vous propose les meilleures pratiques dans les systèmes de fabrication ERP : JobBOSS et Divalto. Avec plus de 20 ans d'expérience dans la mise en œuvre de systèmes ERP (systèmes manufacturiers) et en tant que comptable, son expertise fait en sorte qu'il se veut un entrepreneur hors-pair. Il sera votre allié, il travaille pour vous et avec vous; vous êtes toujours servi avec excellence et recevez des conseils haut-de-gamme pour améliorer la gestion de votre entreprise à travers ces plateformes.\n\nSon souci d'intégrité, sa grande humanité et son esprit authentique font de lui un Leader inspirant avec qui on souhaite être associé professionnellement – et les employés, collaborateurs de MFG, sont d'autant plus heureux de faire partie de son équipe!"
  }
];
